...
output "cluster_certificate_authority_data" {
  description = "Nested attitbute containing certificate-authority-data for your cluster. This is the base64 encoded certificate data required to communicate with your cluster."
...
output "node_group_public_version" {
  description = "Public Node Group Version"
...
output "node_group_private_version" {
  description = "Private Node Group Version"
